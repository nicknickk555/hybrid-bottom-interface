      ...
      <section className="screen model" id="model">
        ...
        <div className="modelGrid">
          ...
          <div className="results">
            ...
            <div className="bars"><div className="barHead"><b>Expected lateral roots / day</b><span>Comparative output</span></div><div className="barPlot"><div className="barItem"><i style={{height:`${Math.min(100,result.center/9*100)}%`}}/><b>{result.center.toFixed(2)}</b><span>Membrane center</span></div><div className="barItem ring"><i style={{height:`${Math.min(100,result.ring/9*100)}%`}}/><b>{result.ring.toFixed(2)}</b><span>Open ring</span></div><div className="barItem total"><i style={{height:`${Math.min(100,result.total/9*100)}%`}}/><b>{result.total.toFixed(2)}</b><span>Total response</span></div></div></div>
